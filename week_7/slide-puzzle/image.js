...
/// TILES
const N_TILES_OPTIONS = [2, 3, 4, 5, 6]; //sizes
const N_TILES = N_TILES_OPTIONS[Math.floor(Math.random() * N_TILES_OPTIONS.length)]; //n of tiles
/// MODES
const MODES = ["Baby", "Toddler", "Teenager", "Adult", "Retired"];
const MODE = MODES[N_TILES_OPTIONS.findIndex((mode) => mode == N_TILES)]; //get mode from n of tiles
